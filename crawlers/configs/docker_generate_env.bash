...
DOCKER_MOONSTREAMCRAWLERS_ENV_FILE="docker.moonstreamcrawlers.env"
...
sed -i 's|^export * ||' "$SCRIPT_DIR/$DOCKER_MOONSTREAMCRAWLERS_ENV_FILE"
sed -i 's|"||g' "$DOCKER_MOONSTREAMCRAWLERS_ENV_FILE"

sed -i "s|^MOONSTREAM_DB_URI=.*|MOONSTREAM_DB_URI=$DOCKER_MOONSTREAMDB_DB_URI|" "$SCRIPT_DIR/$DOCKER_MOONSTREAMCRAWLERS_ENV_FILE"
